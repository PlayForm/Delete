 ...
 */
exports.default = (function (ID, Header) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, fetch("https://api.cloudflare.com/client/v4/accounts/".concat(ID, "/pages/projects"), {
                    headers: Header,
                })];
