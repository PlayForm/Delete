 ...
 */
exports.default = (function (ID, Project, Header) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, fetch("https://api.cloudflare.com/client/v4/accounts/".concat(ID, "/pages/projects/").concat(Project, "/deployments"), {
                    headers: Header,
                })];
            case 1: return [4 /*yield*/, (_b.sent()).json()];
            case 2: return [2 /*return*/, (_a = ((_b.sent()))) === null || _a === void 0 ? void 0 : _a.result];
        }
    });
}); });
